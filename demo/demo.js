...
$.getJSON("hycom_GLBy0p08_surface_current.json", function(data) {
  var velocityLayer = L.velocityLayer({
    displayValues: true,
    displayOptions: {
      velocityType: "Wind",
  ...
  layerControl.addOverlay(velocityLayer, "HYCOM- Global");
});

$.getJSON("hycom_surface_current.json", function(data) {
  var velocityLayer = L.velocityLayer({
    displayValues: true,
    displayOptions: {
      velocityType: "Wind",
  ...
  layerControl.addOverlay(velocityLayer, "HYCOM- GoM");
});
